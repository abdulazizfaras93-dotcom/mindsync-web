...
const T = {
  ar: {
    ...
    s4: {
      packageLabel:   'الباقات',
      packageName:    'ثلاث باقات — نختار لك الأنسب',
      packageDesc:    'نوصّيك بالباقة المناسبة بعد ما نشوف ردودك. تبدأ بتجربة ٣٠ يوم مدفوعة، تُحتسب ضمن رسوم التأسيس.',
      packageFeatures: [
        'موظف الاستقبال — من ٧٩ د.ك / شهر',
        'المنسّق — من ١٤٩ د.ك / شهر (الأكثر طلباً)',
        'المدير — من ٢٩٩ د.ك / شهر',
        'كل الباقات: لهجة كويتية، ردود فورية، صيانة شهرية',
        'تجربة ٣٠ يوم بـ ١٥٠ د.ك — تُحتسب للتأسيس',
      ],
      buildFee:       'من ١٥٥ د.ك تأسيس',
  ...
  en: {
    ...
    prev:      'Previous',
    next:      'Next',
    submit:    'Request my 30-day pilot',
    submitting:'Sending...',
    ...
    s4: {
      packageLabel:   'Plans',
      packageName:    'Three tiers — we pick your best fit',
      packageDesc:    "We'll recommend the right tier after seeing your answers. Start with a paid 30-day pilot, credited to your setup.",
      packageFeatures: [
        'Receptionist — from 79 KWD / mo',
        'Coordinator — from 149 KWD / mo (Most Popular)',
        'Manager — from 299 KWD / mo',
        'Every tier: Kuwaiti dialect, instant replies, monthly maintenance',
        '30-day pilot for 150 KWD — credited to setup',
      ],
      buildFee:       'from 155 KWD setup',
      retainer:       'from 79 KWD / mo',
  ...
  const submit = async () => {
    ...
    try {
      await fetch('https://ifaras911.app.n8n.cloud/webhook/client-discovery', {
        ...
        body: JSON.stringify({ ...form, tier: 'tbd', lang }),
      })
      setStatus('success')
      window.scrollTo({ top: 0, behavior: 'smooth' })
